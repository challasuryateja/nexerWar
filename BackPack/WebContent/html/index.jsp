...
<body>
	...
	<div class="container">
		...
		<div class="row ">
			<div class="col-lg-3 col-mg-4 col-sm-6 portfolio-item">
				<div class="card h-100">
					<a href="#"><img class="card-img-top"
						src="img/solo-travel-myth-bust_1.jpg" alt=""></a>
					<div class="card-body">
						<h6 class="card-title">
							<a href="#">Project One</a>
						</h6>
						<p class="card-text">Ride horses in medieval landscapes &
							enjoy a local lunch 146 review</p>
							<p class="card-text">Ride horses in medieval landscapes &
							enjoy a local lunch 146 review</p>
							<a href="#"><img class="card-imgg"
						src="img/solo-travel-myth-bust_1.jpg" alt=""></a>
					</div>
				</div>
			</div>
